...
<body>
    ...
    <div class="section-1">
        <div class="navbar">
            ...
            <div class="header-tabs">
                <a href="login.php" id="#aa">Notices </a>
                <a href="login.php">Reports </a>
                <a href="login.php">Deadlines </a>
    ...
    <div class="section-3">
        ...
        <div class="content-box">
            ...
            <div class="writeup">
                ...
                margin-right: 40px">Overviews the progress and reports of students and publishes announcements in the notice column. Adding to it, it provides a feature for deadlines too.</p>
    ...
    <div id="section4">
        <div>
            ...
            <p id="perfectpara">Enables the faculty to manage stress-free reports, publishes  <br>announcements and assign deadlines for submissions for <br>future lectures/events.</p>
            <button id="learnmore"><a href="about.php">LEARN MORE</a></button>
        </div>
    ...
    <div id="section5">
        ...
        <div>
            <h1 id="perfect">Accelerate Your Success!</h1>
            <p id="perfectpara">An Efficient easy to use a system that works with a single touch,<br> and lets you manage hundreds of students at a time.</p>
            <button id="learnmore" onclick="about()"><a href="about.php">LEARN MORE</a></button>
        </div>
...
<!--Section-5-->
    <div class="getstarted">
        ...
        <div class="getstartedbuttons">
            <button> <a href="login.php" style="text-decoration: none;">GET STARTED</a></button>
            <button style="margin-left: 20px;"><a href="login.php" style="text-decoration: none;">SIGN UP</a></button>
        </div>
    </div>
